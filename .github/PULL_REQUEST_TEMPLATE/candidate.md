...
- **Sector:**
- **SNR (from the JSON):**
- **Known TOI?** (`known_toi_match` in the JSON — yes/no + id)

## Vetting checklist

- [ ] Produced with `monohunter run` (v0.1.0 or later)
- [ ] I looked at the PNG and the dip is a **real, centered transit** — not an
...
<!-- drag the candidates/tic<TIC>_s<SECTOR>.png here -->

## Notes

<!-- anything odd? nearby known objects? your detrend settings? -->

---
I understand this is a **candidate**, not a confirmed planet — it needs follow-up.
